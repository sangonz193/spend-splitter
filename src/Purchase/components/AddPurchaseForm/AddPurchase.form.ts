...
export type AddPurchaseFormValues = Except<
  z.infer<typeof addPurchaseFormSchema>,
  "buyerId"
> & {
  buyerId: string
}
...
export const useAddPurchaseFormContext = () =>
  useFormContext<AddPurchaseFormValues>()
