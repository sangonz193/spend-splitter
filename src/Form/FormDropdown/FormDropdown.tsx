...
const FormDropdownComponent = <TFormValues extends FieldValues>(
  props: FormDropdownProps<TFormValues>,
) => {
...
export const FormDropdown = React.memo(FormDropdownComponent) as <
